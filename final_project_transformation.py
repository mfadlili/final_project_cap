...
filtered_new_data_type.select(['sk_type','type']).orderBy('sk_type').createOrReplaceTempView('filtered_new_dim_type')
...
filtered_new_data_year_built.select(['sk_year_built','year_built']).orderBy('sk_year_built').createOrReplaceTempView('filtered_new_dim_year_built')
...
filtered_new_data_location.select(['sk_location','state','county','city', 'postal_code']).orderBy('sk_location').createOrReplaceTempView('filtered_new_dim_location')
...
joined_df = joined_df.select(['list_time' , 'property_id', 'name', 'list_price', 'feature', 'photo', 'line', 'status', 'total_sqft', 'building_sqft', 'baths', 'stories', 'beds', 'garage', 'tax_id', 'sk_date', 'sk_location', 'sk_type', 'sk_year_built', 'sk_broker']).createOrReplaceTempView('new_fact_data')
